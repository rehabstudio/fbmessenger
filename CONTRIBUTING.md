...
The [issue tracker](https://github.com/rehabstudio/fbmessenger/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/fbmessenger.git
   # Navigate to the newly cloned directory
   cd fbmessenger
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/rehabstudio/fbmessenger.git
   ```
...
owners to license your work under the terms of the [Apache License](https://github.com/rehabstudio/fbmessenger/blob/master/LICENSE).

<a name="releasing"></a>
## Creating a new release

[Pandoc](http://pandoc.org/installing.html) should be installed in order to convert the README to reStructuredText format for PyPi.

1. Update in `__version__` in `init.py`
...
3. Create the source distributions

   ```bash
   python setup.py sdist bdist_wheel
   ```

4. Upload to PyPi (requires access)
